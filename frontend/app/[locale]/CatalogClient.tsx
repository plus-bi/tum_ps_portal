...
export type Project = {slug: string; reference_code: string; title: string; summary?: string; department: string; chair: string; opportunity_type: "project_study" | "idp"; language?: string; topics: string[]; freshness: string; source_url: string; artifact_url?: string; published_at?: string; first_seen_at: string};
